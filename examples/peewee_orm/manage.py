...
from . import app
from .database import db as DB, User, Message
...
async def devdata():
    ...
    async with DB.connection():
        ...
        await User.get_or_create(email='admin@admin.com', defaults=dict(
            password='admin', role='admin', first_name='Admin',
            last_name='General', picture="https://picsum.photos/id/10/100"
        ))

        await User.get_or_create(email='manager@admin.com', defaults=dict(
